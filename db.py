...
client = MongoClient(
    "mongodb+srv://charles:rTjQgVHm61X5GS8R@tesiscluster-tfsop.mongodb.net/test?retryWrites=true&w=majority")
...
def save_task(user_id: str = '5eada9b16d6559317acacf07', protocol_id: str = '5eada98a6d6559317acacf05', movement_id: str = '5eaeee353a5a3656fbda4ff5'):
    """
    ...
    tarea_doc = {
        "protocol_id": ObjectId(user_id),
        "user_id": ObjectId(protocol_id),
        "movement_id": ObjectId(movement_id),
